...
export default class MyDocument extends Document<MyDocumentInterface> {
  props: any
    ...
    return (
      <html lang="en">
        <Head>
          ...
          <meta name="og:description" content="Olá! I am Gabriel Siedler, a full stack web developer from Brazil." />
